...
+ [MOPAC](./doc/software-mopac.md) — Primarily semi-empirical quantum chemistry package; re-released as open source, sometimes used alongside DFT workflows for large systems.
...
+ [ORCA](./doc/software-orca.md) — Free-for-academic-use quantum chemistry package popular for DFT, TD-DFT, and correlated wavefunction calculations, known for its efficiency and usability.
